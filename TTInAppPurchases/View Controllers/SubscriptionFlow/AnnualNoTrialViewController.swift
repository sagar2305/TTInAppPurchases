...
public class AnnualNoTrialViewController: UIViewController, SubscriptionViewControllerProtocol {
...
//        pricingTopLabel.attributedText = attributedString
        ...
        pricingTopLabel.text = uiProviderDelegate!.subscriptionPrice(for: _index, withDurationSuffix: true).localized
    }
